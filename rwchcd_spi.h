...
int spi_peripherals_r(union rwchc_u_outperiphs * const outperiphs) __attribute__((warn_unused_result));
int spi_peripherals_w(const union rwchc_u_outperiphs * const outperiphs) __attribute__((warn_unused_result));
