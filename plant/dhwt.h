...
struct s_dhwt {
	struct {
		...
		bool logging;			///< true if data logging should be enabled for this dhwt
		...
		bool electric_recycle;		///< if true, recycle pump will be turned on while the DHWT operates in electric self-heating
