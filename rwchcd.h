...
struct s_dhwt_params {
	...
	temp_t t_legionella;		///< target temp for legionella prevention. @warning must be locally or globally < #limit_tmax
...
struct s_pdata {
	...
	struct {
		...
		bool summer_maint;		///< true if summer maintenance is requested
